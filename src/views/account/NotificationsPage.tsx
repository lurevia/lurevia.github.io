...
const TABS: { id: Filter; label: string; icon: typeof Bell }[] = [
  ...
  { id: "verification", label: "Vérification", icon: ShieldAlert },
];
          ...
          {TABS.map((t) => {
            ...
            return (
              <button
                ...
                className={`inline-flex items-center gap-1.5 whitespace-nowrap px-4 py-2 rounded-full text-xs font-bold transition-colors cursor-pointer disabled:opacity-30 ${
                  active
